...
df = pd.read_csv(f"./Infos/{ARTISTA}.csv", sep=";", encoding="utf-8-sig", index_col = 0)
#tabelas de premios das musicas e dos albuns 
premios_musicas = pd.read_csv("./Infos/MusicaEPremios.csv", sep=",", encoding="utf-8-sig", index_col = 0)
premios_albuns = pd.read_csv("./Infos/AlbunsEPremios.csv", sep=",", encoding="utf-8-sig", index_col = 0)
...
dados.to_csv('./Infos/Adele_Com_Premios.csv', encoding="utf-8")
